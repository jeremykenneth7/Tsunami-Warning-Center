                    ...
                    <form action="funct.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 ">
                            ...
                            <select class="form-control" name="status" required="required">
                                    ...
                                    <option <?php if(@$hilang['status']=="1"){echo "selected='selected'";} ?> value="1">Proses</option>
                                    <option <?php if(@$hilang['status']=="2"){echo "selected='selected'";} ?> value="2">Ditemukan</option>
                            </select>
                            </div>
                        </div>
                        <div class="row mb-3">
